...
class RandomCharacterScifi extends Component {
    ...
    handleClick = event => {
        ...
        const backgroundArray = ["Agent", "Android", "Alien", "From Another World", "Pilot", "Astronaut", "ambassador", "Broker", "Hacker", "Engineer", "Mercenary", "High School Jock", "Street Kid", "Wealthy Upbringing", "cyborg", "Bartender", "Band Member", "Record Contract", "Street Thug", "Gangster", "Con Artist", "Burglar", "Prisoner", "Sports Star", "Pro Athlete", "Superstar Athlete", "College Student", "Doctorate", "Field Scientist", "Counsellor", "Military Cadet", "Starfleet Cadet", "Starfleet Ensign", "Starship Engineer", "Starship Science Officer", "Starship Communications Officer", "Starship Counsellor", "Starship Medical Officer", "Starship Security Officer", "Starship Helmsman", "Academy Teacher", "Starbase Inhabitant", "Space Marine", "Starfleet Intelligence Recruit", "Police Officer", "Detective", "Psi-Corps", "Smuggler", "Drifter", "Gambler", "Space Jockey", "Priest", "Nomad", "Corpo", "Street Ninja"]
        ...
        const randomFirstnamefunction = () => {
            ...
            const maleNameArray = ["Bishop", "Bobby", "Case", "Cowboy", "DON.MAC", "Da5id", "Eric", "Gunnar", "Hap", "Harv", "Kaine", "Lucas", "Marid", "Rezin", "Turner", "Vishram", "Bilial", "Alexandre", "Alexios", "Alyn", "Ares", "Artemis", "Astro", "Aukai", "Axel", "Bloom", "Cadium", "Cadmus", "Cael", "Cap", "Court", "Cyno", "Deice", "Dewitt", "Dirk", "Domonique", "Eerie", "Em ", "Fade", "Fawke", "Felix", "Finnick", "Frost", "Game", "Graze", "Grit", "Greeble", "Gully", "Hack", "Hamlet", "Harley", "Hax", "Helvetica", "Hepill", "Hinge", "Hun", "Indigo", "Ismene", "Jabbit", "Jacent", "Jade", "Jago", "Jarno", "Jax", "Jay", "Jiffy", "Jinx", "Kaylene", "Ky", "Knox", "Kade", "Kirone", "Leiloni", "Link", "Lo", "Lonn", "Loot", "Lux", "Lynx", "Mabileen", "Magnum", "Magnus", "Maxx", "Meeki", "Merrick", "Miles", "Mirari", "Nene", "Niko", "North", "Nova", "Oberon", "Onyx", "Orion", "Osson", "Paradox", "Parris", "Persephone", "Pheonix", "Pible", "Pierre", "Pine", "Pip", "Prei", "Quail", "Radius", "Rafeal", "Raze", "Redsuit", "Reglin", "Ren", "Rexx", "Reznor", "Rhye", "Rian", "Riden", "Rocket", "Roscoe", "Rush", "Rust", "Rye", "Ryker", "Rylee"]
            const femaleNameArray = ["Acrona", "Cerise", "Dore", "Erythrina", "Geneva", "India", "Ista", "Janis", "Kay", "Laura" , "Marly", "Maxine", "Molly", "Ahn", "Ajaz", "Alexia", "Amethyst", "Andra", "Andromeda", "Annia", "Apoch", "Ariana", "Aries", "Arris", "Asta", "Astra", "Astria", "Atsu", "Aura", "Aurora", "Ava", "Avalon", "Aves", "Aylo", "Azura", "Bebe", "Bellatrix", "Bet", "Bit", "Blythe", "Calla", "Callista", "Calypso", "Case", "Cass", "Cassia", "Catalina", "Cecelia", "Ceres", "Clare", "Clariss", "Clarity", "Clea", "Cosima", "Cressidia", "Dalas", "Dara", "Daryl", "Delmare", "Delphina", "Delphine", "Denari", "Dephina", "Dervillia", "Dot", "Ecru", "Eerie", "Eilo", "Elea", "Electra", "Ellio", "Em", "Ember", "Eva", "Evadne", "Eve", "Eve", "Farrah", "Fawke", "Faya", "Felidae", "Felix", "Finnick", "Freya", "Frost", "Futura", "Gabriella", "Gai", "Genesis", "Geneva", "Gevie", "Glory"]
            const nonBinaryNameArray = ["Bishop", "Bobby", "Case", "Cowboy", "DON.MAC", "Da5id", "Eric", "Gunnar", "Hap", "Harv", "Kaine", "Lucas", "Marid", "Rezin", "Turner", "Vishram", "Bilial", "Alexandre", "Alexios", "Alyn", "Ares", "Artemis", "Astro", "Aukai", "Axel", "Bloom", "Cadium", "Cadmus", "Cael", "Cap", "Court", "Cyno", "Deice", "Dewitt", "Dirk", "Domonique", "Eerie", "Em ", "Fade", "Fawke", "Felix", "Finnick", "Frost", "Game", "Graze", "Grit", "Greeble", "Gully", "Hack", "Hamlet", "Harley", "Hax", "Helvetica", "Hepill", "Hinge", "Hun", "Indigo", "Ismene", "Jabbit", "Jacent", "Jade", "Jago", "Jarno", "Jax", "Jay", "Jiffy", "Jinx", "Kaylene", "Ky", "Knox", "Kade", "Kirone", "Leiloni", "Link", "Lo", "Lonn", "Loot", "Lux", "Lynx", "Mabileen", "Magnum", "Magnus", "Maxx", "Meeki", "Merrick", "Miles", "Mirari", "Nene", "Niko", "North", "Nova", "Oberon", "Onyx", "Orion", "Osson", "Paradox", "Parris", "Persephone", "Pheonix", "Pible", "Pierre", "Pine", "Pip", "Prei", "Quail", "Radius", "Rafeal", "Raze", "Redsuit", "Reglin", "Ren", "Rexx", "Reznor", "Rhye", "Rian", "Riden", "Rocket", "Roscoe", "Rush", "Rust", "Rye", "Ryker", "Rylee", "Acrona", "Cerise", "Dore", "Erythrina", "Geneva", "India", "Ista", "Janis", "Kay", "Laura" , "Marly", "Maxine", "Molly", "Ahn", "Ajaz", "Alexia", "Amethyst", "Andra", "Andromeda", "Annia", "Apoch", "Ariana", "Aries", "Arris", "Asta", "Astra", "Astria", "Atsu", "Aura", "Aurora", "Ava", "Avalon", "Aves", "Aylo", "Azura", "Bebe", "Bellatrix", "Bet", "Bit", "Blythe", "Calla", "Callista", "Calypso", "Case", "Cass", "Cassia", "Catalina", "Cecelia", "Ceres", "Clare", "Clariss", "Clarity", "Clea", "Cosima", "Cressidia", "Dalas", "Dara", "Daryl", "Delmare", "Delphina", "Delphine", "Denari", "Dephina", "Dervillia", "Dot", "Ecru", "Eerie", "Eilo", "Elea", "Electra", "Ellio", "Em", "Ember", "Eva", "Evadne", "Eve", "Eve", "Farrah", "Fawke", "Faya", "Felidae", "Felix", "Finnick", "Freya", "Frost", "Futura", "Gabriella", "Gai", "Genesis", "Geneva", "Gevie", "Glory"]
            ...
            <div>
                <fieldset className='random-form'>
                    <form onSubmit={this.handleClick} >
                        <button type="submit" className='random-button'>Random <b>Sci-fi</b> Character</button>
                    </form>
                </fieldset>
            </div>
        )
