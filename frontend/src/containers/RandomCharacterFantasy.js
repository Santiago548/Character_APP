...
class RandomCharacterFantasy extends Component {
    ...
    handleClick = event => {
        ...
        const backgroundArray = ["Abyssdweller", "Adopted", "Afflicted", "Air Acrobat", "Alchemic Construct", "Alchemist", "Alcoholic", "Alcoholic Scientist", "Amnesiac", "Ancient Cultist", "Ancient King", "Ancient One", "Anthropologist", "Antiquarian", "Apothecary", "Apprentice of Disguise", "Arcana Spy, Variant", "Arcana Spy", "Arcane Augmented", "Arcane Dominion", "Archaeologist", "Archivist", "Arranged Marriage", "Artist", "Arvoreen Keeper", "Aspirant", "Assistant", "Astronaut", "Balloon Mage", "Banker", "Barber", "Barmaid", "Bartender", "Battlesmith", "Beastlike", "Bedouin", "Beggar", "Bereaved", "Bodyguard", "Booyahg Acolyte", "Born of Darkness", "Born of the Far Realm", "Bounty Hunter", "Butler", "Cattle Rustler", "Changeling", "Charlatan Thief", "Chief Guard", "Child", "Child of Ares", "Chronicler", "City Guard", "City Worker", "Clone", "Collector", "Combat Medic", "Confederacy of Feuding Houses", "Conscript", "Construct", "Courtesan", "Crazed Hermit", "Crusader Nation", "Cultist of the Ash-Veined", "Cursed, Variant", "Cursed", "Dandy", "Dark Lord", "Defyer of Fate", "Deluded", "Noble", "Demonologist", "Denizen", "Detective", "Diplomat", "Disciple of the Obscure", "Disgrace", "Divine", "Doctor", "Dog of the Military", "Dragon Trained", "Dragonshore Buccaneer", "Drow Breeding Slave", "Drunken Bum", "Drunken Pirate", "Duelist, Variant", "Duelist", "Earthling", "Elysium Knight", "Employee of Royalty", "Endless Divine Soul of Darkness Incarnate", "Endless Soul", "Engineer", "Envoy", "Eternal One", "Ex-Blood Doll", "Executioner", "Exile", "Exiled Ruler", "Experiment", "Experimenter", "Explorer", "Falconer", "Fallen Hero", "Fallen Noble", "Family Business", "Fated", "Feared", "Fearful", "Feral Child", "Fey Child", "Feychild", "Firefighter", "Forgotten", "Formerly Petrified", "Fortune Teller", "From The Past", "Futureborn", "Gambler", "Gladiator, Variant", "God Touched", "Governess", "Gravetender", "Grey Creed Guild)", "Heir of a Fallen Kingdom", "Hellborn", "Heretic", "Hired Guard", "Hitman", "Hooded Figure", "House Worker", "Immortal", "Infected", "Innkeeper", "Inquirer", "Interplanar Merchant", "Interspecies Orphan", "Isekai", "Islander", "Jack Of All Trades", "Janitor", "Jester", "Jockey", "Knight Sororitas", "Law Bringer, Variant", "Law Bringer", "Librarian", "Linguistician", "Lore Keeper", "Lost Civilization", "Lover", "Loyal Priest", "Lucky Fumbler", "Lumberjack", "Mafioso", "Mage", "Maid", "Mailman", "Malfunctioning", "Marshal", "Master Inquisitor", "Member of The Court of Gaia", "Mercenary", "Messenger", "Metal Worker", "Militant assassin", "Military Asset", "Military Pilot", "Miner", "Minion", "Monastic", "Monastic Traveller", "Monster", "Monster Hunter", "Monstrozoologist, Variant", "Monstrozoologist", "Mortician", "Mute", "Mystic", "Navy SEAL", "Negotiator", "Noble Dragon Tamer", "Noble Guard", "Nomad", "Nurse", "Oathbreaker", "Occult Investigator", "Occultist", "Oracle", "Otherworlder, Variant", "Paranoid Agent", "Pilot", "Planar Traveler", "Plane Walker", "Politician", "Possesed Body", "Powerless Mage", "Primitive Tribe", "Prisoner", "Proctor", "Prodigy", "Professional Assassin, variant", "Professional Assassin", "Prospector", "Psychic", "Psycho", "Puppeteer", "Redeemed Cultist", "Regime of the Dark Overlord", "Researcher", "Retired Hero", "Revenant", "Revolutionist", "Rider", "Ringleader", "Rite of Rebirth", "Rival", "Roamer", "Royal Cavalryman", "Royalty", "Runaway", "Sadistic Assassin", "Salesman", "Scavenger", "Scout", "Sealed One", "Secret", "Sentinel", "Serial Killer", "Sex Slave", "Sex Worker", "Shadow Thieves' Guild Member", "Shadow Touched", "Shipwright", "Side Character", "Simpleton", "Slaver", "Slayer", "Sleuth", "Smuggler, Variant", "Smuggler", "Solid", "Soulless", "Spirit Medium", "Split Personality", "Splitting Body", "Spy", "Squire", "Steampunker", "Storyteller", "Stranded", "Student of Magic", "Survivor", "Tailor", "Temple Guardian", "Tempter", "Test Subject", "The Chosen One", "Time Frozen", "Time Traveller", "Torturer", "Town Apothecary", "Tragic Knight", "Transformed Monster", "Urban Vigilante", "Vagrant Trouper", "Vampire", "Vaquero", "Venator", "Village Dunce", "Wanderer", "Wandering Mercenary", "War Criminal", "Warforged", "Warrior of a Lost Age", "Well Travelled", "Wielder of the Old One", "Witch", "Witch Doctor", "Witch Hunter", "Wolf Knight", "Woodcutter", "Wooddweller", "Worshipped One", "Writer", "Wronged Hero", "Zealot"]
...
export default connect(null, { addCharacter })(RandomCharacterFantasy)
